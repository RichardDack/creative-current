// src/components/ui/NavbarLogo.tsx - Simple logo for navbar
'use client';
  ...
  return (
    ...
    >
      <svg
        ...
        style={{ display: 'block' }}
      >
        <title id="navbar-logo-title">Creative Current</title>
        
        {/* Logo icon container */}
        <g transform="matrix(0.76249462,0,0,0.76249462,-10.955981,-10.832051)">
          {/* Top logo part (teal) */}
          <g>
            <path
              ...
              fill="var(--color-primary, #31afb4)"
              fillRule="evenodd"
              transform="matrix(0.12,0,0,0.12,-58.183,-59.7)"
            />
          </g>
          
          {/* Bottom logo part (gray) */}
          <g transform="translate(0,40)">
            <path
              ...
              fill={variant === 'light' ? 'rgba(0, 0, 0, 0.6)' : 'rgba(255, 255, 255, 0.7)'}
              fillRule="evenodd"
