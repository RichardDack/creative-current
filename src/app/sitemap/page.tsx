// src/app/sitemap/page.tsx - Static XML Sitemap
...
${allPages.map(page => `  <url>
  ...
  return (
    <div style={{ fontFamily: 'monospace', whiteSpace: 'pre', fontSize: '12px' }}>
      {sitemapXml}
    </div>
  );
}
...
export const metadata = {
  title: 'Sitemap | Creative Current',
};

// Add this to your app router to serve as XML
// You'll also want to add this route handler:
